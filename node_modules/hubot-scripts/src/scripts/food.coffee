...
module.exports = (robot) ->
  ...
  robot.respond /fuzz me ([^ ]*) (.*)/i, (msg) ->
    ...
    ordrin.restaurant.getDetails restaurant_id, unlessErr msg, (res) ->
      msg.reply pretty_json getItemsFromFuzz msg.match[2], res.menu
    #ordrin.restaurant.getDeliveryList new Date, address, unlessErr msg, (res) ->
    #  msg.reply pretty_json getRestaurantsFromFuzz msg.match[1], res
